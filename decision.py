...
# آستانه‌های بازتنظیم‌شده (بود: 78 / 22):
# رفع باگ موتور فاندینگ (که قبلاً همیشه ۵۰ برمی‌گرداند و میانگین را
# مصنوعاً به سمت وسط می‌کشید) + فیلتر جدید «تأیید اجباری تایم‌فریم بالاتر»
# در main.py هر دو عامل کاهنده‌ی تعداد سیگنال هستند؛ برای جبران و رسیدن
# به تعداد سیگنال منطقی (بدون قربانی‌کردن اعتبار)، آستانه‌ها اندکی به سمت
# وسط بازتنظیم شدند.
BUY_THRESHOLD = 72
SELL_THRESHOLD = 28
